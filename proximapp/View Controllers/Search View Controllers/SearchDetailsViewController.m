...
//  proximapp
//
//  Created by Paula Leticia Geronimo on 08/01/21.
//
...
#pragma mark - Search Product

- (void)SearchProductViewController:(SearchProductViewController *)controller didPickIemWithLocation: (PFGeoPoint *)location author:(NSString *)author img:(PFFileObject *)image price:(NSNumber *)price {
    //PFObject *post = [Post post];
    // prodName, image, price, location
...
#pragma mark - Setting up VC with items
